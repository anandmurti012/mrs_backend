...
module.exports.transactions = (bookingId, type, fees) => {
    try {
                    ...
                    if (results.length === 0) {
                        ...
                        connection.query(
                            ...
                            [
                                fees,
                                type,
                                type === 'debit' ? parseInt(balance) - parseInt(fees) : parseInt(balance) + parseInt(fees),
                                new Date(),
                                transactionId
                            ],
                            (error3, updateResults) => {
                                if (error3) {
                                    ...
                                    console.log("Transaction successfully updated with new balance:");
                                }
                            }
                        );
                    }
